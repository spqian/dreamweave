...
1. Run `report`. Its small JSON gives `report_path`, `manifest_path`, `review_index`, `digest`, `item_count`, and the canonical host-neutral schema pointer (`<engine>/docs/JUDGMENT-SURFACES.md`).
